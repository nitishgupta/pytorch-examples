...
from model.lstmnet import RNNModel
from model.ffnet import FF


class Model(nn.Module):
		def __init__(self, vocab_size, embed_size, hidden_size, num_layers, numlabels):
			...
			self.llstm = RNNModel(vocab_size, embed_size, hidden_size, num_layers)
			self.rlstm = RNNModel(vocab_size, embed_size, hidden_size, num_layers)
